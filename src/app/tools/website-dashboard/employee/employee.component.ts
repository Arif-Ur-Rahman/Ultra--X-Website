...
export class EmployeeComponent implements OnInit {
  ...
  displayedColumns = ['checkbox','index','emp_name','emp_id', 'details', 'designation', 'image', 'status', 'action'  ];
  ...
  ngOnInit(): void {
    ...
    this.Data.get_employee(post_data).subscribe({
