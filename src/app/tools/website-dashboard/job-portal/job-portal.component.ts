...
export class JobPortalComponent implements OnInit {
  ...
  displayedColumns = ['checkbox','index','notice_title','notice_id', 'details','position', 'date','deadline', 'status', 'action'  ];
  ...
  ngOnInit(): void {
    ...
    this.Data.get_job(post_data).subscribe({
